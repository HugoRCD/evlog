...
- Replaying historic events into a dashboard before switching to a live in-process subscription. See the [replay-then-live recipe](/build-on-top/observers/consumer-recipes#3-replay-history-then-go-live).
