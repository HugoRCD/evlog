...
Real-world patterns that combine the [stream API](/build-on-top/observers/in-process-stream), the [stream server](/build-on-top/observers/stream-server), and the [filesystem reader](/adapters/self-hosted/fs).
