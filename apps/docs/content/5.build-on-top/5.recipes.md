...
Real-world patterns that combine the [stream API](/build-on-top/stream-api), the [stream server](/build-on-top/stream-server), and the [filesystem reader](/adapters/self-hosted/fs).
