...
- Skip on serverless platforms (Vercel Functions, Cloudflare Workers, AWS Lambda) — the server is in-process

Docs: https://www.evlog.dev/build-on-top/stream-server
::
