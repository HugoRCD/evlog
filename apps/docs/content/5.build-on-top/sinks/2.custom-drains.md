...
- [Drain pipeline](/build-on-top/sinks/drain-pipeline) — wrap your drain in batch + retry + buffer overflow protection
- [Identity headers](/build-on-top/sinks/identity-headers) — what your drain advertises on every request
- [Drains as packages](/build-on-top/shared/drains-as-packages) — publish your drain as `@my-org/evlog-loki`
