...
## How the session reaches the event
...
| `createAuthIdentifier(auth)` | Nitro `request` hook factory for standalone Nitro apps. See [Performance](/use-cases/better-auth/performance#standalone-nitro). |
