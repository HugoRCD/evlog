...
It accepts the same options as [`createAuthMiddleware`](/use-cases/better-auth/middleware#options).

## Combine with the AI SDK

When you also use [`evlog/ai`](/use-cases/ai-sdk/overview), your wide events include both user identity **and** AI metrics in a single event:
