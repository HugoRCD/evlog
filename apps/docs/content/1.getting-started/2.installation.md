...
evlog provides Express middleware at `evlog/express`. It auto-creates a request-scoped logger on `req.log` and emits a wide event when the response finishes.
