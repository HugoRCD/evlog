---
title: Introduction
description: A TypeScript logging library focused on wide events and structured error handling. Replace scattered logs with one comprehensive event per request.
navigation:
  icon: i-lucide-info
links:
  - label: Quick Start
