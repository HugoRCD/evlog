---
title: SvelteKit
description: Wire the handle and handleError hooks once, and every SvelteKit request carries a logger on `event.locals.log` until the response ends.
navigation:
  title: SvelteKit
...
::prompt
---
description: Set up evlog in my SvelteKit app
icon: i-simple-icons-svelte
actions:
  - copy
  - cursor
...
Docs: https://www.evlog.dev/integrate/frameworks/sveltekit
...
See the [Vite Plugin docs](/reference/vite-plugin) for all options.
