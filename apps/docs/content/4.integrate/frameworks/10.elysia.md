---
title: Elysia
description: The plugin derives `log` into every route context, so an Elysia handler reads it as a parameter and the wide event closes with the response.
navigation:
  title: Elysia
...
Docs: https://www.evlog.dev/integrate/frameworks/elysia
