...
description: Send wide events to PostHog as custom events for product analytics, session replay correlation, and structured log querying in your dashboards.
navigation:
  title: PostHog
