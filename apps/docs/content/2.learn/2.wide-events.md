...
Docs: https://www.evlog.dev/learn/wide-events
...
For AI SDK streaming responses, supported framework integrations defer wide-event emit until the response body finishes, so `createAILogger(log)` metadata lands on the same request event automatically.
...
- [Simple Logging](/learn/simple-logging) - Fire-and-forget logs when you don't need context accumulation
- [Typed Fields](/learn/typed-fields) - Add compile-time type safety to your wide events
- [Structured Errors](/learn/structured-errors) - Errors with actionable context
