...
- [Sampling](/learn/sampling) - Configure head and tail sampling
- [Adapters](/integrate/adapters/overview) - Send events to external platforms
- [Enrichers](/use-cases/enrichers) - Add derived context automatically
