...
#body
  ...
  :::features-feature-use-anywhere
  ---
  link: /use-cases/cli-and-scripts
  link-label: Browse use cases
  ---
  #headline
  Use evlog anywhere

  #title
  One logger, :br every context

  #description
  CLIs, libraries, background jobs, edge workers, monorepos. Drop-in for console.log, pino, or consola — and a free upgrade to wide events the moment you want them. Same API, same drains, same redaction, same types.
  :::
