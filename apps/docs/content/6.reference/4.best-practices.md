...
This automatically masks credit cards (`****1111`), emails (`a***@***.com`), IPs, phone numbers, JWTs, Bearer tokens, and IBANs in all wide events — before console output and before any drain. See [Auto-Redaction](/learn/redaction) for the full configuration reference.
