...
No HTTP framework? evlog runs the same way in [CLIs and scripts](/use-cases/cli-and-scripts), [libraries](/use-cases/libraries), [background jobs](/use-cases/background-jobs), [serverless and edge](/use-cases/serverless-and-edge), and [monorepos](/use-cases/monorepos).
::
