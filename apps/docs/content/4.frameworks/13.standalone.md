...
End-to-end recipes per context live in [Use cases](/use-cases/cli-and-scripts) — CLIs, libraries, jobs, edge, and monorepos. This page covers the standalone API surface; use cases cover the patterns.
::
