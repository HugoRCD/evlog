...
description: Create errors that explain why they occurred and how to fix them. Add actionable context with why, fix, and link fields.
navigation:
...
See the [Next.js example](/examples/nextjs) for a working implementation.
::
