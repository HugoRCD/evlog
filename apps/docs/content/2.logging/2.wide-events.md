...
Not running an HTTP framework? See [Use cases](/use-cases/cli-and-scripts) for CLI, library, background job, edge, and monorepo patterns — wide events apply just as cleanly outside of request lifecycles.
::
