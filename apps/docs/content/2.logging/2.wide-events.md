...
Wide events are the core concept behind evlog. Instead of scattering logs throughout your codebase, you accumulate context over any unit of work — a request, script, job, or workflow — and emit a single, comprehensive log event.
