...
Looking for a logger you can use everywhere — CLIs, libraries, jobs, edge — without switching APIs? See [Use cases](/use-cases/cli-and-scripts) for end-to-end patterns per context.
::
...
- [Use cases](/use-cases/cli-and-scripts): CLI, library, job, edge, and monorepo patterns
