...
5. Set BETTER_STACK_API_KEY environment variable
6. Test by triggering a request and checking the Better Stack logs dashboard

Adapter docs: https://www.evlog.dev/integrate/adapters/cloud/better-stack
...
|--------|------|---------|-------------|
| `apiKey` | `string` | - | Better Stack source token (required) |
| `sourceToken` | `string` | - | **Deprecated.** Use `apiKey` instead |
