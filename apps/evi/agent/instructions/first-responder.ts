...
Keep the reply to one comment, the draft response Hugo builds on. This turn may add or update labels on this issue, open a doc-gap issue, and assign Hugo, and nothing else: the channel posts the comment.`
