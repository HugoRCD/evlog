...
- [#412](https://github.com/HugoRCD/evlog/pull/412) [`b4d4baf`](https://github.com/HugoRCD/evlog/commit/b4d4baf840e707f4b09d31cb51d6e9a7fb483e45) Thanks [@HugoRCD](https://github.com/HugoRCD)! - Fix Nuxt auto-import types for `useLogger`, `log`, `parseError`, and related helpers. The Nuxt module now sets `typeFrom: 'evlog'` / `'evlog/client'` so generated declarations resolve through package exports instead of extensionless `dist/` paths that typed as `any`.
